...
export const DashboardIcon = ({ size = 20, ...props }: IconProps) => (
  <svg className="shrink-0" width={size} height={size} fill="none" viewBox="0 0 24 24" stroke="currentColor" {...props}>
...
export const ProductIcon = ({ size = 20, ...props }: IconProps) => (
  <svg className="shrink-0" width={size} height={size} fill="none" viewBox="0 0 24 24" stroke="currentColor" {...props}>
    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M20 7l-8-4-8 4m16 0l-8 4m8-4v10l-8 4m0-10L4 7m8 4v10M4 7v10l8 4" />
  </svg>
);

export const RevenueIcon = ({ size = 24, ...props }: IconProps) => (
...
export const ArrowCollapseIcon = ({ size = 20, ...props }: IconProps) => (
  <svg width={size} height={size} fill="none" viewBox="0 0 24 24" stroke="currentColor" {...props}>
